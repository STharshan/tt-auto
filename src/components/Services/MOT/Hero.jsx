      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 relative z-10">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="px-3 py-1 rounded-md bg-[#0055ff] text-xs font-semibold uppercase tracking-wide shadow-md">
              Date
            </div>
            <div className="px-4 py-1 rounded-md bg-white/5 text-sm font-medium backdrop-blur-md border border-white/10">
              23/12/2024
            </div>
          </div>
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
            Our goal was to highlight their innovative approach while providing
            a friendly experience that makes it easy to explore their services.
          </p>

          {/* Tags */}
          <div className="flex gap-4 pt-4">
            <div className="px-5 py-2 bg-linear-to-t from-[#0055ff33] to-[#9999991a] border border-white/10 rounded-lg backdrop-blur-sm">
              <p className="text-white text-sm font-medium">SASS</p>
            </div>
            <div className="px-5 py-2 bg-linear-to-t from-[#0055ff33] to-[#9999991a] border border-white/10 rounded-lg backdrop-blur-sm">
        ...
        <div className="relative bg-linear-to-br from-[#001533] via-[#010a1a] to-[#001b3f] rounded-2xl p-10 border border-white/10 shadow-[0_0_80px_-20px_rgba(0,85,255,0.5)] overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            <div>
              ...
              <h4 className="text-xl font-semibold">Framer Development</h4>
            </div>
            ...
            <div>
              ...
              <h4 className="text-xl font-semibold">Chris Williamson</h4>
            </div>

            <a
              href="https://www.framer.com/?via=westhill97"
              target="_blank"
