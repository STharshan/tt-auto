  ...
  return (
    <section className="bg-black text-white py-20 px-6 lg:px-16 font-[Inter]">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          <h2 className="text-4xl font-bold mb-6 text-[#E1912F]">Get In Touch</h2>
        ...
        <form className="bg-[#111] p-8 rounded-2xl shadow-lg">
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full p-3 rounded-md bg-[#1A1A1A] text-gray-200 border border-gray-700 focus:border-[#E1912F] outline-none"
            />
            <input
              type="email"
            ...
            <button
              type="submit"
              className="bg-[#E1912F] text-black font-semibold py-3 px-6 rounded-md hover:bg-[#f09f3f] transition"
            >
              Send Message
            </button>
          </div>
